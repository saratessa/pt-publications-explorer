...
{=html}
<style>
/* Make Crosstalk/ionRangeSlider pink for BOTH skins (flat + shiny) */
...
.irs--flat .irs-line, .irs--shiny .irs-line {
  background-color: #f8d3e0 !important;
}
/* prevent hover/active flicker back to blue */
