...
```{r}
pink_css <- htmltools::tags$style(htmltools::HTML("
/* Crosstalk filter_slider() uses ionRangeSlider (flat theme) */
.irs--flat .irs-bar,
.irs--flat .irs-from,
.irs--flat .irs-to,
.irs--flat .irs-single { background-color:#E91E63; }

.irs--flat .irs-handle > i:first-child { background-color:#E91E63; }

.irs--flat .irs-line { background-color:#fde4ee; }   /* light track */
.irs--flat .irs-grid-pol { background:#E91E63; }     /* tick marks */
"))
